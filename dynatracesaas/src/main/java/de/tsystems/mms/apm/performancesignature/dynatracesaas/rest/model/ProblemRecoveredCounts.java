 ...
 */
@ApiModel(description = "The number of entities which were affected, but recovered, per impact level.")

public class ProblemRecoveredCounts {
    ...
    public ProblemRecoveredCounts APPLICATION(Integer APPLICATION) {
    ...
    public ProblemRecoveredCounts ENVIRONMENT(Integer ENVIRONMENT) {
    ...
    public ProblemRecoveredCounts INFRASTRUCTURE(Integer INFRASTRUCTURE) {
    ...
    public ProblemRecoveredCounts SERVICE(Integer SERVICE) {
    ...
    public String toString() {
        return "class ProblemRecoveredCounts {\n" +
