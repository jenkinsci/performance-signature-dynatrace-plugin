 ...
 */
@ApiModel(description = "The number of monitored entities per impact level.")
...
public class ProblemFeedQueryResultMonitored {
    ...
    public ProblemFeedQueryResultMonitored ENVIRONMENT(Integer ENVIRONMENT) {
    ...
    public ProblemFeedQueryResultMonitored INFRASTRUCTURE(Integer INFRASTRUCTURE) {
    ...
    public ProblemFeedQueryResultMonitored SERVICE(Integer SERVICE) {
    ...
    public String toString() {
        return "class ProblemFeedQueryResultMonitored {\n" +
