                ...
                if (json[index].show) {
                    if (json[index].id === 'unittest_overview') {
                        $('.carousel-inner', carousel).append('<div class="carousel-item">' +
                            '<img class="img-thumbnail" height="280" src="performance-signature/testRunGraph?width=500&amp;height=300&amp;' + randomParam + '">' + '</div>');
                    } else {
                        $('.carousel-inner', carousel).append('<div class="carousel-item">' +
                            '<img class="img-thumbnail" height="280" src="performance-signature/summarizerGraph?width=500&amp;height=300&amp;id=' + json[index].id + '&amp;' + randomParam + '">' + '</div>');
                    }
                }
            });
